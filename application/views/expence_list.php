						...
						<div class="col-12">
							<div class="card">
								<div class="col-sm-12 card-header">
									<a class="btn btn-block btn-danger btn-sm"href="<?php echo base_url();?>index.php/admin_controller/addexpence">
									<b> Add Expense</b>
									</a>
								</div>
							  <!-- /.card-header -->
								...
								<tr>
									...
									<td class="project-actions">
										<a class="btn btn-info btn-sm" href="<?php echo base_url()?>index.php/admin_controller/expence_edit/<?=$r['id'];?>">
											  <i class="fas fa-pencil-alt">
											  </i>
											  Edit
										</a>
										<a class="btn btn-danger btn-sm" href="<?php echo base_url()?>index.php/admin_controller/expence_delete/<?=$r['id'];?>">
