...
<div class="wrapper">
	...
	<!-- Sidebar Start -->
		...
		<?php $m="ssr"; include('includes/admin/sidebar.php'); ?>
			...
			<div class="row mb-2">
			  ...
			  <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				  ...
				  <li class="breadcrumb-item active">Service Wise Sales Reports</li>
				</ol>
			  </div>
			</div>
		  </div>
					...
					<div class="col-md-12">
						...
						<div class="card card-primary">
						  <div class="card-header">
							<h3 class="card-title">Sales Reports Search Service Wise</h3>
						  </div>
						  <!-- /.card-header -->
						  <!-- form start -->
							<form action="<?php echo base_url();?>index.php/admin_controller/salesservicereports" method="POST">
								<div class="card-body">
								
									<div class="form-group">
										<label>Search Service</label>
										<select class="form-control" name="searchservice" id="searchservice">
						...
						<div class="card card-primary">
						  ...
						  <!-- form start -->
								<div class="card-body">
									...
									<?php $i=1; if($searched_service){ foreach ($searched_service as $r){ ?>
										<tr>
											<td><?=$i;?></td>
											<td><?=$r['serial_no'];?></td>
