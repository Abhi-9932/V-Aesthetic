...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php  $m="userdashboard"; include('includes/user/sidebar.php'); ?>
					...
					<div class="row mb-2">
					  ...
					  <div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
						  ...
						  <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/user-dashboard">Dashboard</a></li>
						</ol>
					  </div>
					</div>
				</div><!-- /.container-fluid -->
			  ...
			  <!--- Lead list start--->
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title"><b>Lead Details</b></h3>
				  </div>
				  
				  <div class="card-body">
					<table id="example2" class="table table-bordered table-hove leadTable">
					  <thead>
					   <tr>
							<th>Serial No</th>
				...
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title"><b>Sales Details</b></h3>
				  </div>
				...
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title"><b>Tickets Details</b></h3>
				  </div>
				...
				<div class="card card-primary">
				  <div class="card-header">
					<h3 class="card-title"><b>Expenses Details</b></h3>
				  </div>
				  <!-- /.card-header -->
				  <div class="card-body">
