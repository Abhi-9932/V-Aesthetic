...
<div class="wrapper">
	...
	<!-- Sidebar Start -->
		...
		<?php $m="ssr"; include('includes/user/sidebar.php'); ?>
			...
			<div class="row mb-2">
			  ...
			  <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				  ...
				  <li class="breadcrumb-item active"> Service wise Reports</li>
				</ol>
			  </div>
			</div>
		  </div>
					...
					<div class="col-md-12">
						...
						<div class="card card-primary">
						  <div class="card-header">
							<h3 class="card-title">Sales Reports Service Wise</h3>
						  </div>
						  <!-- /.card-header -->
						  <!-- form start -->
							<form action="<?php echo base_url();?>index.php/user_controller/salesservicereportsUser" method="POST">
								<div class="card-body">
