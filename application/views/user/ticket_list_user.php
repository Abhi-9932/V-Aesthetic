						...
						<div class="col-12">
							<div class="card">
								<div class="col-sm-12 card-header">
									<a class="btn btn-block btn-danger btn-sm"href="<?php echo base_url();?>index.php/user_controller/addticketuser">
									<b> Add Ticket</b>
									</a>
								</div>
							  <!-- /.card-header -->
									...
									<table id="example1" class="table table-bordered table-striped">
									  ...
									  <tbody>
										...
										<tr>
											...
											<td><?=$r['time'];?></td>
											<td><?=$r['issues'];?></td>
											<td><a class="btn btn-danger btn-sm" href="<?php echo base_url()?>index.php/user_controller/ticket_delete/<?=$r['id'];?>">
