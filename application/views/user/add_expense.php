	...
	<div class="wrapper">
	  ...
	  <!-- Main Sidebar -->
	  <?php $m="expense"; include('includes/user/sidebar.php'); ?>
					...
					<div class="row mb-2">
					  ...
					  <div class="col-sm-6">
						<ol class="breadcrumb float-sm-right">
						  ...
						  <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/expense-list"> Expense</a></li>
										 ...
										 <div class="card card-primary">
											  <div class="card-header">
												<h3 class="card-title">Add Expense</h3>
												  ...
												  <!-- /.card-header -->
												  <!-- form start -->
												  <form action="<?php echo base_url();?>index.php/user_controller/expensedo" method="POST">
													<div class="card-body">
													  ...
													  <div class="form-group">
														...
														<input type="text" class="form-control" id="expence" name="expence_person" placeholder="<?=$this->session->userdata('username'); ?>" value="<?=$this->session->userdata('username'); ?>" readonly>
													  </div>
													</div>
