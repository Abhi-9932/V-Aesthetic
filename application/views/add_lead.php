			...
			<div class="row mb-2">
			  ...
			  <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				  ...
				  <li class="breadcrumb-item"><a href="<?php echo base_url();?>index.php/lead">Lead</a></li>
				  ...
				  <!-- left column -->
					<div class="col-md-12">
						...
						<div class="card card-primary">
						  ...
						  <!-- /.card-header -->
						  <!-- form start -->
							<form action="<?php echo base_url();?>index.php/admin_controller/leaddo" method="POST">
								<div class="card-body">
								<!--
								...
								-->
									...
									<div class="form-group">
										...
										<input type="phone" class="form-control" id="exampleInputcontact" name="phone" placeholder="Enter your Contact"required>
									</div>
									<div class="form-group">
										<label>Address</label>
