...
<div class="wrapper">
	...
	<!-- Sidebar Start -->
		...
		<?php $m="llr"; include('includes/admin/sidebar.php'); ?>
			...
			<div class="row mb-2">
			  ...
			  <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				  ...
				  <li class="breadcrumb-item active">Location Wise Lead Reports</li>
				</ol>
			  </div>
			</div>
		  </div>
				  ...
				  <!-- left column -->
					<div class="col-md-12">
						...
						<div class="card card-primary">
						  ...
						  <!-- /.card-header -->
						  <!-- form start -->
							<form action="<?php echo base_url();?>index.php/admin_controller/leadlocationreports" method="POST">
								<div class="card-body">
