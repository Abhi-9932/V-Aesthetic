...
<body class="hold-transition sidebar-mini">
	<div class="wrapper">
		...
		<!-- Sidebar Start -->
			...
			<?php $m="tickets"; include('includes/admin/sidebar.php'); ?>
									...
									<table id="example1" class="table table-bordered table-striped">
									  ...
									  <tbody>
										...
										<tr>
											...
											<td><?php if($r['file1']=="N/A"){echo "N/A";}else{ ?><a target="_blank" href="<?php echo base_url(); ?>tools/upload/user/<?=$r['file2'];?>">View</a><?php } ?> </td>
											<td><?php if($r['file1']=="N/A"){echo "N/A";}else{ ?><a target="_blank" href="<?php echo base_url(); ?>tools/upload/user/<?=$r['file3'];?>">View</a><?php } ?> </td>
											<td><?=$r['date'];?></td>
											<td><?=$r['time'];?></td>
											<td><?=$r['issues'];?></td>
